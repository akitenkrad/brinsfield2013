...
//! ergonomics (mirroring the knoll2013 / chuang2024 convention).
//!
...
//! mechanism) + the prompt→response cache provide the pseudo-determinism that
//! keeps the deterministic socsim core reproducible.
